...
func (_m *UserService) Create(args service.UserCreateArgs) error {
	ret := _m.Called(args)
...
func (_m *UserService) Get(id uint64) (service.UserResponse, error) {
	ret := _m.Called(id)
...
func (_m *UserService) GetAll() ([]service.UserResponse, error) {
	ret := _m.Called()
...
func (_m *UserService) Update(args service.UserUpdateArgs) error {
	ret := _m.Called(args)
...
func (_m *UserService) ValidateLogin(username string, passwd string) (service.UserLoginResponse, error) {
